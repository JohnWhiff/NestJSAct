...
var changeStatusDto = /** @class */ (function () {
    function changeStatusDto() {
    }
    __decorate([
        (0, class_validator_1.IsString)(),
        (0, class_validator_1.IsIn)(['rejected', 'approved'], { message: 'Status must be either "rejected" or "approved"' }),
